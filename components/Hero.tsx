      ...
      <div className="container-custom section-padding relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            ...
            that make a difference. Passionate about clean code and modern
            design.
          </motion.p>
...
>>>>>>> 0164a0b475eec4d872758eafc88f5b1d8fa07a96
            <motion.a
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
          ...
          >
            <motion.a
              ...
              href="https://github.com/tonidobrinski"
              target="_blank"
            ...
            <motion.a
              whileHover={{ scale: 1.1, y: -2 }}
              href="https://www.linkedin.com/in/toni-dobrinski-187819242/"
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 rounded-full bg-white dark:bg-dark-800 shadow-lg hover:shadow-xl transition-all duration-300"
            >
