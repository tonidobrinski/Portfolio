...
const Skills = () => {
  ...
  const technologies = [
    { name: 'React', icon: SiReact, color: 'bg-cyan-400' },
    { name: 'Next.js', icon: SiNextdotjs, color: 'bg-black dark:bg-white' },
    ...
    { name: 'Express.js', icon: SiExpress, color: 'bg-gray-800' },
    ...
    { name: 'Vercel', icon: SiVercel, color: 'bg-black dark:bg-white' },
    { name: 'Figma', icon: SiFigma, color: 'bg-pink-600' },
    { name: 'Redux', icon: SiRedux, color: 'bg-purple-600' },
    { name: 'Material UI', icon: SiMui, color: 'bg-blue-500' },
    { name: 'Chakra UI', icon: SiChakraui, color: 'bg-cyan-400' },
    { name: 'Insomnia', icon: SiInsomnia, color: 'bg-indigo-600' },
    { name: 'Postman', icon: SiPostman, color: 'bg-orange-500' },
    { name: 'Selenium', icon: SiSelenium, color: 'bg-green-500' },
  ]
